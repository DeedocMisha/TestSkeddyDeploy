...
</button>`,P=["data-button-text","data-hide-button-icon","data-button-position","data-button-color","data-button-text-color","data-toggle-off"];class f extends HTMLElement{constructor(){super();const e=this.dataset,t=e.buttonText,a=e.buttonPosition,o=e.buttonColor,r=e.buttonTextColor,n=`<style>${window.Cal.__css}</style> ${M({buttonText:t,buttonClasses:[f.updatedClassString(a,"")],buttonColor:o,buttonTextColor:r})}`;this.attachShadow({mode:"open"}),this.assertHasShadowRoot(),this.shadowRoot.innerHTML=n}static updatedClassString(e,t){return[t.replace(/hidden|md:right-10|md:left-10|left-4|right-4/g,""),e==="bottom-right"?"md:right-10 right-4":"md:left-10 left-4"].join(" ")}static get observedAttributes(){return P}attributeChangedCallback(e,t,a){var s,h,p;const o=(s=this.shadowRoot)==null?void 0:s.querySelector("#button"),r=(h=this.shadowRoot)==null?void 0:h.querySelector("button"),n=(p=this.shadowRoot)==null?void 0:p.querySelector("#button-icon");if(!o)throw new Error("#button not found");if(!r)throw new Error("button element not found");if(!n)throw new Error("#button-icon not found");if(e==="data-button-text")o.textContent=a;else if(e==="data-hide-button-icon")n.style.display=a=="true"?"none":"block";else if(e==="data-button-position")r.className=f.updatedClassString(a,r.className);else if(e==="data-button-color")r.style.backgroundColor=a;else if(e==="data-button-text-color")r.style.color=a;else if(e==="data-toggle-off"){const l=a=="true";l&&(this.buttonWrapperStyleDisplay=r.style.display),r.style.display=l?"none":this.buttonWrapperStyleDisplay}else console.log("Unknown attribute changed",e,t,a)}assertHasShadowRoot(){if(!this.shadowRoot)throw new Error("No shadow root")}}const B=`@keyframes loader{0%{transform:rotate(0)}25%{transform:rotate(180deg)}50%{transform:rotate(180deg)}75%{transform:rotate(360deg)}to{transform:rotate(360deg)}}@keyframes loader-inner{0%{height:0%}25%{height:0%}50%{height:100%}75%{height:100%}to{height:0%}}.loader-inner{vertical-align:top;display:inline-block;width:100%;animation:loader-inner 2s infinite ease-in}.loader{display:block;width:30px;height:30px;position:relative;border-width:4px;border-style:solid;animation:loader 2s infinite ease}.loader.modal-loader{margin:60px auto}
`,E=i=>i==="404"?"Error Code: 404. Cal Link seems to be wrong.":`Error Code: ${i}. Something went wrong.`;function $(i){const e={};if(i===null)return e;for(const[t,a]of i)if(e.hasOwnProperty(t)){let o=e[t];Array.isArray(o)||(o=[o]),o.push(a),e[t]=o}else e[t]=a;return e}const q=`<div id="wrapper" style="top:50%; left:50%;transform:translate(-50%,-50%)" class="absolute z-highest">
...
<slot></slot>`;class N extends HTMLElement{static get observedAttributes(){return["loading"]}assertHasShadowRoot(){if(!this.shadowRoot)throw new Error("No shadow root")}attributeChangedCallback(e,t,a){this.assertHasShadowRoot();const o=this.shadowRoot.querySelector(".loader"),r=this.shadowRoot.querySelector("#error"),n=this.shadowRoot.querySelector("slot");if(!o||!n||!r)throw new Error("One of loaderEl, slotEl or errorEl is missing");if(e==="loading"){if(a=="done")o.style.display="none";else if(a==="failed"){o.style.display="none",n.style.visibility="hidden",r.style.display="block";const s=E(this.dataset.errorCode);r.innerText=s}}}constructor(){super(),this.attachShadow({mode:"open"}),this.assertHasShadowRoot(),this.shadowRoot.innerHTML=`<style>${window.Cal.__css}</style><style>${B}</style>${q}`}}const T=`@keyframes loader{0%{transform:rotate(0)}25%{transform:rotate(180deg)}50%{transform:rotate(180deg)}75%{transform:rotate(360deg)}to{transform:rotate(360deg)}}@keyframes loader-inner{0%{height:0%}25%{height:0%}50%{height:100%}75%{height:100%}to{height:0%}}.loader-inner{vertical-align:top;display:inline-block;width:100%;animation:loader-inner 2s infinite ease-in}.loader{display:block;width:30px;height:30px;position:relative;border-width:4px;border-style:solid;animation:loader 2s infinite ease}.loader.modal-loader{margin:60px auto}
`,_=`<style>
.my-backdrop {
  position:fixed;
  width:100%;
